...
/** Compact storefront footer — legal bar only (nav columns commented out below). */
export default function HomeFooter() {
  const year = new Date().getFullYear()

  return (
    <footer className="mt-8 border-t border-[rgba(130,210,185,0.12)] bg-[#050f0c] py-4 text-[#66887D]">
      <div className={`${SECTION_MAX} ${SECTION_X}`}>
        {/*
        Brand + SHOP / SERVICES / COMPANY / SUPPORT — restore when needed.
