...
import PhoneMockup from '@/modules/customer/components/landing/PhoneMockup'
import { TRUST_BADGES } from '@/shared/mocks/landingData'
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-5 md:px-12 pt-16 pb-20 md:pt-24 md:pb-28 flex flex-col lg:flex-row items-center gap-14 lg:gap-8">
        <div className="flex-1 max-w-2xl">
          ...
          <h1
            className="text-3xl sm:text-5xl lg:text-6xl font-black leading-[1.08] mb-6 text-white"
