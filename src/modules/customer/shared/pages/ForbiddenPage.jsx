...
export default function ForbiddenPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-4 px-6 text-center" style={{ background: colors.pageBg }}>
      <p className="text-[54px] font-extrabold" style={{ color: '#ff8a80' }}>403</p>
      <p className="text-[15px]" style={{ color: colors.textMuted }}>{msg('common.forbidden')}</p>
      <Button as={Link} to={homePathForRole(role)} size="lg">Back to my portal</Button>
    </div>
  )
}
